...
# Add finetune/ to sys.path so `from utils import ...` resolves.
# utils.py and the other finetune helpers live in ./finetune/.
import sys as _sys
from pathlib import Path as _Path
_sys.path.insert(0, str(_Path(__file__).resolve().parent / "finetune"))

import torch
import random
from utils import parse_letter_from_model_text
